...
namespace ItiN
{
    ...
    public class ElementFinder
    {
        ...
        public ElementFinder(ArrayList elementTags, IElementCollection elementCollection)
            : this(elementTags, null, elementCollection)
        { }
        ...
        public ElementFinder(string tagName, string inputType, IElementCollection elementCollection)
            : this(tagName, inputType, null, elementCollection)
        { }
        ...
        //    throw new ItiNException("Element didn't reach readystate = complete within 30 seconds: " + element.outerText);
        //}
