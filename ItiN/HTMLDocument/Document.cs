    ...
    public abstract class Document : IElementsContainer, IDisposable, IElementCollection
    {
        ...
        public Element ActiveElement
        {
            get
            {
                ...
                {
                    return ItiN.Element.GetTypedElement(domContainer, activeElement);
                }
                return null;
            }
        }
        ...
        {
            return Span(Find.ByCustom("ClassName", elementId));
        }
        ...
        {
            return Div(Find.ByCustom("ClassName", elementId));
        }
...
# region WatiN Elements Not Supported in ItiN
