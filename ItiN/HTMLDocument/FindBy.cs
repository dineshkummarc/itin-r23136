...
namespace ItiN
{
    ...
    public class Not : Attribute
    {
        ...
        public Not(Attribute attribute)
            : base("not", string.Empty)
        {
            if (attribute == null)
            {
    ...
    public class StyleAttribute : Attribute
    {
        ...
        public StyleAttribute(string styleAttributeName, string value)
            : base(attributeName + styleAttributeName, value)
        { }
        ...
        public StyleAttribute(string styleAttributeName, Regex regex)
            : base(attributeName + styleAttributeName, regex)
        { }
    ...
    public class For : Attribute
    {
        ...
        public For(string forId)
            : base(attributeName, forId)
        { }
        ...
        public For(Element element)
            : base(attributeName, element.Id)
        { }
    ...
    public class Title : Attribute
    {
        ...
        /// </summary>
        /// <param name="comparer">The comparer.</param>
        public Title(ICompare comparer)
            : base(attributeName, comparer)
        { }
    }
    ...
    public class Value : Attribute
    {
        ...
        /// </summary>
        /// <param name="comparer">The comparer.</param>
        public Value(ICompare comparer)
            : base(attributeName, comparer)
        { }
    }
