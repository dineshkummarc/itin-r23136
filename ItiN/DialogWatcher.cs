...
namespace ItiN
{
    ...
    public class DialogWatcher : IDisposable
    {
        ...
        private bool closeUnhandledDialogs = InfopathTester.Settings.AutoCloseDialogs;
        private int referenceCount = 0;

        private static ArrayList dialogWatchers = new ArrayList();
        private Exception lastException;
        private static string InfoPathWarningStyleInHex = String.Empty;
        ...
        {
            this.infopathProcessId = ieProcessId;
        ...
        public void DecreaseReferenceCount()
        {
            ...
            {
                throw new ApplicationException("Reference count exception in DialogWatcher.");
            }
        ...
        public static string WarningStyleInHex
        {
            get { return InfoPathWarningStyleInHex; }
            set { InfoPathWarningStyleInHex = value; }
        }
